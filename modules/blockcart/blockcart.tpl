...
<div id="cart_block" class="block exclusive">
	...
	{if $discounts|@count > 0}
		...
		<p id="cart-buttons">
			...
			<a href="{$link->getPageLink("$order_process", true)}" id="button_order_cart" class="exclusive{if $order_process == 'order-opc'}_large{/if}" title="{l s='Checkout' mod='blockcart'}" rel="nofollow">{l s='Checkout' mod='blockcart'}</a>
		</p>
	</div>
	</div>
</div>
