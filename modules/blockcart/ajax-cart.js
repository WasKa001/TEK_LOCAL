...
floating_box.append('<a href="'+checkout_link+'" rel="nofollow" class="exclusive">'+ checkout_txt+'</a>');
floating_box.append('<a href="" rel="nofollow" class="close-popup button">'+ continue_txt+'</a>');
