...
class OrderOpcControllerCore extends ParentOrderController
{
	...
	{
		if (!$this->isLogged)
			return '<p class="warning">'.Tools::displayError('To continue, please fill in the delivery address form above and click the "Save and continue" button, othewrise you will not be able to complete your order.').'</p>';
